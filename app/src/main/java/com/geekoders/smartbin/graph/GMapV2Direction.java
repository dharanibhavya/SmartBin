package com.geekoders.smartbin.graph;
...
import com.hackerearth.bookaride.MainActivity;
...
public class GMapV2Direction
{
    ...
    public GMapV2Direction(Context ctx)
    {
        this.context = ctx;
    }

    public void getDocument(LatLng start,
                            LatLng end,
                            String mode,
